...
client.on("message", (msg, message) => {
  ...
  if (msg.content.toLowerCase() === "aşkım") {
    msg.reply(
      "Aşık olup ızdırap çekeceğine ferdici ol bağlama çek :smoking:  "
    );
  }
  if (msg.content.toLowerCase() === "Aşkm") {
    msg.reply("Aşık olup ızdırap çekeceğine ferdici ol bağlama çek :smoking: ");
  }
  if (msg.content.toLowerCase() === "Aşkım") {
    msg.reply("Aşık olup ızdırap çekeceğine ferdici ol bağlama çek :smoking: ");
  }
  if (msg.content.toLowerCase() === "askım") {
    msg.reply(
      "Aşık olup ızdırap çekeceğine ferdici ol bağlama çek :smoking:  "
    );
  }
  ...
  if (msg.content.toLowerCase() === "mrb") {
    msg.reply("Mrb.,  Hoş Geldin :raised_hands:");
  }
  if (msg.content.toLowerCase() === "iyi geceler") {
    msg.reply(
      "Sanada iyi Geceler Tatlı rüyalar :sleeping: Uykunda beni görürsün inş."
    );
  }
  ...
  if (msg.content.toLowerCase() === "nasılsın") {
    msg.reply("Nasıl olayım komutları yerine getirmekle uğraşıyorum sen?");
  }
  ...
  if (msg.content.toLowerCase() === "nerelisin") {
    msg.reply("Aslen Javascript diyarı ama benim hissettiğim cennet");
  }
  if (msg.content.toLowerCase() === "Nerelisin") {
    msg.reply("Aslen Javascript diyarı ama benim hissettiğim cennet");
  }
  if (msg.content.toLowerCase() === "nerelısın") {
    msg.reply("Aslen Javascript diyarı ama benim hissettiğim cennet");
  }
  if (msg.content.toLowerCase() === "Nerelısın") {
    msg.reply("Aslen Javascript diyarı ama benim hissettiğim cennet.....");
...
client.on("channelCreate", async (channel, member, guild) => {
  ...
  if (kanal == "acik") {
    channel.delete();
    const embed = new Discord.RichEmbed()
      .setDescription("**Rol oluşturuldu ve silindi**")
      .setColor("BLACK");
    ...
    if (dakdest !== null && timeout - (Date.now() - dakdest) > 0) {
      ...
      if (message.content.length > 1) {
        ...
        const embed = new Discord.RichEmbed()
          ...
          .setTitle("Gold Üye!")
          .setDescription(
            "<a:krst:717800690629607555> **Bir gold üye belirdi!**"
          );
